...
export const defaultSiteContent: SiteContent = {
  global: {
    ...
    footerTagline: "Private journeys across Sri Lanka",
  ...
  home: {
    ...
    heroPromise: "We arrange private island tours, Colombo airport transfers and reliable bike rentals across Sri Lanka — shaped around the way you want the island to feel.",
