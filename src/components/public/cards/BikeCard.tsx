  ...
  return (
    <article className="bike-card" data-cursor-depth>
      <div className="bike-card__visual">
        ...
        <Image src={bike.image} alt={`${bike.name} available for rental in Weligama, Sri Lanka`} loading={index < 3 ? "eager" : "lazy"} decoding="async" width={1920} height={1280} sizes="(max-width: 1024px) 100vw, 50vw"/>
      ...
      <div className="bike-card__body">
        ...
        <div className="bike-card__footer bike-card__footer--request">
          <p className="bike-card__request-note">Request a quote — we confirm availability and price personally.</p>
