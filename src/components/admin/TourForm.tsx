    ...
    <form className="admin-form" onSubmit={submit}>
      <section className="admin-form-card">
        ...
        <div className="admin-form-grid admin-form-grid--2">
          ...
          <label className="admin-form-span-2"><span>Image path or URL *</span><input name="image" defaultValue={tour?.image ?? "/images/tour-sigiriya.svg"} required /><small>Use a public URL or a file placed inside /public/images.</small></label>
