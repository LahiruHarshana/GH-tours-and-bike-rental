...
import { AnimatedCatalogGrid } from "@/components/ui/AnimatedCatalogGrid";
...
export default async function BikesPage() {
  ...
  return (
    <>
      <section className="inner-hero inner-hero--bikes modern-section"><div className="container inner-hero__grid"><Reveal><div><span className="eyebrow eyebrow--light"><i />Ride your own rhythm</span><h1>Two wheels.<br /><em>One unforgettable island.</em></h1><p>Reliable scooters, road bikes and adventure machines with safety gear and human support.</p></div></Reveal><Reveal delay={100} className="inner-hero__art" direction="right"><figure data-scroll-motion><img src="/images/bike-road.jpg" alt="Motorbike ready on a quiet forest road" /><figcaption><span>Freedom, responsibly</span><strong>Helmet · Handover · Support</strong></figcaption></figure></Reveal></div></section>
