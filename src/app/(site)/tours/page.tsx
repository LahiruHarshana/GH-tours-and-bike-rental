    ...
    <>
      <section className="inner-hero inner-hero--tours modern-section">
        <div className="container inner-hero__grid">
          ...
          <Reveal delay={100} className="inner-hero__art" direction="right"><figure data-scroll-motion><img src="/images/sigiriya.jpg" alt="Sigiriya rock fortress surrounded by Sri Lanka's forest" /><figcaption><span>Cultural Triangle</span><strong>Ancient stone · Early light</strong></figcaption></figure></Reveal>
        </div>
      </section>
