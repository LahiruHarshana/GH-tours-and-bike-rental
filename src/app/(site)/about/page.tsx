...
export const metadata: Metadata = createPageMetadata({
  title: "About GH Tours & Bike Rental",
  description:
    "Meet the local Sri Lanka team behind GH Tours & Bike Rental, arranging private island tours, airport transfers and bike rentals across the country.",
  path: "/about",
});
  ...
  return (
    <>
      <section className="simple-hero simple-hero--story">
        ...
        <div className="container"><Reveal><span className="eyebrow eyebrow--light"><i />A local Sri Lanka team</span><h1>Local knowledge.<br /><em>Genuine welcome.</em></h1><p>Sri Lanka is our home. Your journey should feel like your own.</p></Reveal></div>
      </section>
      <ServiceBar />
      <section className="section about-page modern-section">
        <div className="container about-page__grid">
          <Reveal direction="left"><figure data-scroll-motion><Image src="/images/hero-coast.webp" alt="Palm trees and the Indian Ocean on Sri Lanka's southern coast"  width={1920} height={1280} sizes="(max-width: 1024px) 100vw, 50vw"/><figcaption>Southern Province · Sri Lanka</figcaption></figure></Reveal>
          <Reveal delay={100} direction="right"><div><span className="eyebrow"><i />Our philosophy</span><h2>We want you to remember how Sri Lanka felt.</h2><p className="lead-copy">Not only the places you photographed, but the tea shared by the roadside, the sudden rain over a temple roof and the driver who knew exactly where to stop for sunset.</p><p>GH Tours & Bike Rental is built around private, flexible travel across Sri Lanka. We combine dependable operations with the warmth and spontaneity that make the island special.</p><div className="about-values"><span><strong>Respect</strong>For guests, communities and the island.</span><span><strong>Clarity</strong>Honest plans, prices and communication.</span><span><strong>Care</strong>Real support from arrival to departure.</span></div></div></Reveal>
        </div>
      </section>
